...
これは [AIネイティブな仕事の作法](https://aiseed.dev/ai-native-ways/)（構造）を、
**組織全体のIT**に適用する実践です。個人の道具（[工房](../kobo/)・[文庫](../bunko/)）と
同じ原則——開いた標準・構造化・テキスト主軸・中身と外枠の分離——を、組織の規模で
貫きます。作法が個人から組織へ地続きに広がることの実証でもあります。
